"""Shared fixtures for wiki generator tests -- in-memory SQLite with seed data."""
...
INSERT INTO turn_turns (civ_id, turn_number, title, summary, raw_message_ids, turn_type, game_date_start, technologies, resources, beliefs, geography, choices_proposed, choices_made) VALUES
    (1, 1, 'Fondation', 'Les cinq castes fondent la cite au confluent des deux fleuves.', '[]', 'standard', 'An 1', NULL, '["Poisson","Bois"]', '["Culte des Cinq Elements"]', '["Confluent des deux fleuves"]', NULL, NULL),
    (1, 2, 'Premier Contact', 'Les eclaireurs rapportent une presence etrangere.', '[]', 'first_contact', 'An 5', NULL, NULL, NULL, NULL, '["Envoyer une delegation diplomatique","Renforcer les defenses"]', '["Envoyer une delegation diplomatique"]'),
...
@pytest.fixture
def db():
    """Create an in-memory SQLite database with seed data and row_factory."""
